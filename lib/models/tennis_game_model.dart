...
class TennisGameModel {
  String host;
  int team;
  int S1T1; // Set 1 points for Team 1
  int S2T1; // Set 2 points for Team 1
  int S3T1; // Set 3 points for Team 1
  int S1T2; // Set 1 points for Team 2
  int S2T2; // Set 2 points for Team 2
  int S3T2; // Set 3 points for Team 2
  String risultato; // Result of the match
  String hostUsername;
  String userId;
  String date;
  int permissions;
  String club;
  String giorno; // Day of the match
  int set; // Current set number
  String sport;

  /// Constructor with all required fields for TennisGameModel
  TennisGameModel({
    required this.host,
    required this.team,
    required this.S1T1,
  ...
  /// Creates a TennisGameModel from a JSON map
  ...
  /// Creates a TennisGameModel from a Firestore document snapshot
  ...
  /// Converts the TennisGameModel instance to JSON map
